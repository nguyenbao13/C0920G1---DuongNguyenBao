...
value (1, 'Thượng hạng'), (2, 'Cao cấp'), (3, 'Phổ thông');
...
insert into dich_vu (id_dich_vu, ten_dich_vu, dien_tich, so_tang, so_nguoi_toi_da, chi_phi_thue, id_kieu_thue, id_loai_dich_vu, trang_thai) value
(1, 'villa', 123, 123, 13, 1231312, 1, 1, 'trong'),
(2, 'house', 123, 123, 13, 1231312, 1, 1, 'trong'),
(3, 'room', 123, 123, 13, 1231312, 1, 1, 'trong'),
(4, 'villa', 123, 123, 13, 1231312, 1, 1, 'trong');

insert into hop_dong (id_hop_dong, id_nhan_vien, id_khach_hang, id_dich_vu, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, tong_tien) value
...
insert into hop_dong_chi_tiet (id_hop_dong_chi_tiet , id_hop_dong , id_dich_vu_di_kem , so_luong) value
(2, 2, 2, 13), (3, 3, 3, 14), (4, 4, 4, 15);