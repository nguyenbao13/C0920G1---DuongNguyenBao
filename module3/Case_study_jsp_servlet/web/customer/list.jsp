                ...
                <div class="modal-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <th>Birthday</th>
                            <td>
                                <input type="text" name="birthday" id="birthday" size="45" required pattern="^\d{4}(\/|-)\d{2}(\/|-)\d{2}$"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Gender</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="idCard" id="idCard" size="45" required pattern="^\d{9}|\d{12}$"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Phone number</th>
                            <td>
                                <input type="text" name="phone" id="phone" size="45" required pattern="^(09|\(84\)\+9)[01]\d{7}$"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Email</th>
                            <td>
                                <input type="text" name="email" id="email" size="45" required pattern="^\w{3,}(\.?\w+)*@[a-z]{2,7}(.[a-z]{2,5}){1,3}$"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Address</th>
